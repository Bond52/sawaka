...
|------|------------|------------------|-------------------|---------|
| Relative political stability | Cameroon recorded a political stability score of approximately **-1.56 in 2024** (scale -2.5 to +2.5), indicating stability below the global average, with localized tensions but no generalized institutional collapse. | Indirect risk on field activities (partnerships, events, local deployment), with no direct legal impact on Sawaka as an international association. | ⚠️ Moderate risk (contextual) | https://www.theglobaleconomy.com/Cameroon/wb_political_stability/ |
| Limited administrative capacity | Cameroon ranks among the **bottom ~20% globally** in Government Effectiveness, reflecting weak administrative capacity and limited policy implementation. | Administrative delays do not directly affect Sawaka legally, but indirectly influence coordination with local partners, field deployment, and community adoption speed. | ⚠️ Moderate risk (indirect) | https://donnees.banquemondiale.org/indicateur/GE.PER.RNK?locations=CM |
...
| Factor | Observation | Impact on Sawaka | Risk / Opportunity | Sources |
|------|------------|------------------|-------------------|---------|
| Multilingual context | Cameroon is officially bilingual (French and English) and includes several hundred local languages used in daily and economic life. | The user interface must be available at minimum in **French and English** to ensure accessibility and adoption. Local languages can be addressed through simplified, visual, or community-based content. | ✅ Inclusion | — |
...
| Factor | Observation | Impact on Sawaka | Risk / Opportunity | Sources |
|------|------------|------------------|-------------------|---------|
| Mobile dominance | Growth in Internet usage in Cameroon is driven primarily by **smartphone adoption**, with PCs remaining marginal. | A **mobile-first approach** is mandatory; priority on mobile-compatible web or application experiences. | ✅ Opportunity | https://datareportal.com/reports/digital-2026-cameroon |
| Variable network quality | Network coverage is uneven nationwide, with coexistence of 2G, 3G, and 4G and varying performance by region. | The solution must tolerate weak networks and provide lightweight, resilient interaction modes and degraded functionality when needed. | ⚠️ Risk | https://www.gsma.com/coverage/#318 |
...
| Factor | Observation | Impact on Sawaka | Risk / Opportunity | Sources |
|------|------------|------------------|-------------------|---------|
| E-commerce framework | Cameroon has a decree regulating e-commerce, mainly targeting formal and transactional platforms, with limited enforcement. | The non-transactional model positions Sawaka as a visibility and matchmaking platform, with transactions occurring via third-party channels (WhatsApp, Facebook, direct contact), reducing legal exposure at launch. | ⚠️ Risk (limited at launch) | https://www.cameroontradeportal.cm/tradeportal/templates/Tip_accueil/docs/decret/Decret_relatif_au_commerce_electronique.pdf |
